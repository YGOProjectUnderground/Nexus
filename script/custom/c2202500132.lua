...
function s.tkntg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,2202500133,SET_RITUAL_BEAST_TAMER|SET_GUSTO,0x4011,200,1000,2,RACE_PSYCHIC,ATTRIBUTE_WIND) end
	Duel.SetOperationInfo(0,CATEGORY_TOKEN,nil,1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,0,0)
end
function s.tknop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,2202500133,SET_RITUAL_BEAST_TAMER|SET_GUSTO,0x4011,200,1000,2,RACE_PSYCHIC,ATTRIBUTE_WIND) then
			local token=Duel.CreateToken(tp,2202500133)
