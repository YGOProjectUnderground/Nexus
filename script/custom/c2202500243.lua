...
s.listed_names={2202500242}
function s.cfilter(c)
	return c:IsCode(2202500242) and c:GetCounter(0xf15)>7 and c:IsFaceup()
end
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
function s.tgcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,2202500242),tp,LOCATION_ONFIELD,0,1,nil)
end
