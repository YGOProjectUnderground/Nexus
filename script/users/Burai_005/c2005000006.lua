...
function s.initial_effect(c)
	...
	--Destroy 1 Spell/Trap and Recover 1 "Prank-Kids" monster
...
function s.thfilter(c)
	return c:IsSetCard(0x120) and c:IsMonster() and c:IsAbleToHand() and not c:IsCode(id)
end
