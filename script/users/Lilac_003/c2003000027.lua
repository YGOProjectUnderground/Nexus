...
function s.lpop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct>199 and Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,2003000028),tp,LOCATION_ONFIELD,0,1,nil) then
		Duel.BreakEffect()
		Duel.Damage(1-tp,ct,REASON_EFFECT)
	end
end
function s.setfilter(c)
	return c:IsCode(2003000028) and not c:IsForbidden()
end
