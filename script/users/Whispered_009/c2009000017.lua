...
function s.initial_effect(c)
	--Discard then SpSummon 1 Level 1 Effect Plant monster
...
function s.spfilter(c,e,tp)
	return c:IsRace(RACE_PLANT) and c:IsType(TYPE_EFFECT) and c:IsLevel(1) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
